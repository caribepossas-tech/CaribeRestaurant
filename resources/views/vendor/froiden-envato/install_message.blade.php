...
<html>
<head>
    <title>RestPOS No instalado</title>
            ...
            <div class="flex items-center space-x-4">
                ...
                <div class="flex-1">
                    <h3 class="text-lg font-semibold text-red-700 mb-1">
                        RestPOS Instalación necesaria - kosari.net
                    </h3>
                    <p class="text-red-600">
                        Es necesario instalar la aplicación antes de poder utilizarla. Vaya al instalador para completar la instalación.
                    </p>
