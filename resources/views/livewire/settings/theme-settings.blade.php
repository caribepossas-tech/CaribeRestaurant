                                ...
                                <div class="flex items-center space-x-4">
                                    <div class="flex-shrink-0">
                                        <div id="filePreview{{ $name }}"
                                            ...
                                            style="background-image: url('{{ ${$name} ? ${$name}->temporaryUrl() : asset('user-uploads/favicons/restaurant/' . restaurant()->hash . '/' . restaurant()->$name) }}'); background-size: contain; background-repeat: no-repeat;">
                                        </div>
                                    </div>
