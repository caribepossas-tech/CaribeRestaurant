                                        ...
                                        <td
                                            ...
                                            @else
                                                <div class="flex flex-col items-end gap-1">
                                                    ...
                                                    @if(in_array($item->payment_method, ['offline', 'qr']) && $item->receipt)
                                                        <a href="{{ $item->receipt_url }}" target="_blank" class="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 text-xs flex items-center gap-1">
                                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
