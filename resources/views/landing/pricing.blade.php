            ...
            <div class="bg-white border border-gray-200 rounded-xl p-6 dark:bg-neutral-900 dark:border-neutral-800">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex items-center justify-between">
                        <span class="text-sm text-gray-800 dark:text-neutral-200">{{ $moduleName }}</span>
        ...
        <div class="hidden lg:block overflow-x-auto" x-data="{ isAnnual: {{ $monthlyPackages->count() == 0 && $annualPackages->count() > 0 ? 'true' : 'false' }} }">
            ...
            <div class="flex gap-6">
              ...
              <!-- Header -->
                ...
                @foreach($packages as $package)
                <div class="min-w-48"  x-show="(!isAnnual && {{ $package->monthly_status ? 'true' : 'false' }} || isAnnual && {{ $package->annual_status ? 'true' : 'false' }} || {{ $package->package_type == \App\Enums\PackageType::LIFETIME ? 'true' : 'false' }})">
                    <!-- Header -->
            ...
            <div class="space-y-4 mt-6">
                ...
                <ul class="flex gap-6 relative">
                    ...
                    @endphp
                    <li class="py-1.5 lg:py-3 px-4 lg:px-0 lg:text-center bg-gray-50 dark:bg-neutral-800 min-w-48" x-show="(!isAnnual && {{ $package->monthly_status ? 'true' : 'false' }} || isAnnual && {{ $package->annual_status ? 'true' : 'false' }} || {{ $package->package_type == \App\Enums\PackageType::LIFETIME ? 'true' : 'false' }})">
