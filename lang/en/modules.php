...
return [
    ...
    'backup' => [
        ...
        'restore'             => 'Restore',
        'restoring'           => 'Restoring...',
        'restoreSuccess'      => 'Backup restored successfully. Database and files have been restored.',
        'restoreFailed'       => 'Backup restore failed',
        'restoreWarning'      => 'Restoring a backup will overwrite the current database and storage files. This action cannot be undone.',
        'confirmRestore'      => 'Are you sure? This will overwrite the entire database and current files. This action CANNOT be undone.',
        'invalidBackup'       => 'The ZIP file is not a valid backup',
        'selectFile'          => 'Select backup ZIP file',
